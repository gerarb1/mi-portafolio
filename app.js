...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      fb_tag: 'Recomendaciones Profesionales',
      fb_title: 'Feedback & Qué Agregar a Tu Portafolio',
      fb_sub: 'Análisis técnico sobre cómo llevar tu perfil como Desarrollador Backend a un nivel competitivo internacional.',
      fb1_title: '1. Botón para Descargar CV (PDF)',
      fb1_desc: 'Incluye una versión descargable en PDF de tu Currículum Vitae (en español e inglés) directo en el Hero Section. Los reclutadores suelen preferir descargar el CV rápidamente tras ver tu portafolio.',
      fb2_title: '2. Diagramas de Arquitectura SQL',
      fb2_desc: 'En la sección de tu proyecto ERP Avícola, agrega un esquema entidad-relación (ERD) o diagrama de la estructura de tablas SQL. Esto demuestra inmediatamente tu dominio real en diseño de bases de datos.',
      fb3_title: '3. Widget de Commits / GitHub Stats',
      fb3_desc: 'Agrega una tarjeta interactiva con tus estadísticas de GitHub (repositorios, contribuciones, lenguajes más usados). Transmite transparencia y constancia en tu aprendizaje.',
      fb4_title: '4. Formulario de Contacto Funcional',
      fb4_desc: 'Integra un servicio como Web3Forms o Formspree directamente en el formulario de la web para recibir mensajes instantáneos en tu email gerardoburgos1232@gmail.com sin abrir clientes externos.',
      fb5_title: '5. Recomendaciones Académicas / Testimonios',
      fb5_desc: 'Pide a 1 o 2 profesores universitarios o tutores de proyectos una breve reseña de tu dedicación y ética de trabajo para incluirla como elemento de prueba social (Social Proof).',
      fb6_title: '6. Certificaciones & Logros Universitarios',
      fb6_desc: 'Al estar en tu último año de carrera, destaca tus materias sobresalientes, proyectos finales, hackathones o certificaciones adicionales (Node.js, SQL, AWS/Docker básico).',
    ...
    en: {
      ...
      fb_tag: 'Professional Recommendations',
      fb_title: 'Feedback & Portfolio Upgrades',
      fb_sub: 'Technical advice on how to raise your Backend Developer profile to international competitive standards.',
      fb1_title: '1. Add a Download Resume (PDF) Button',
      fb1_desc: 'Provide a direct PDF link to your CV (both in ES and EN) right in the Hero Section. Recruiters prefer downloading resumes quickly upon visiting.',
      fb2_title: '2. SQL Architecture & ER Diagrams',
      fb2_desc: 'Inside your Poultry ERP project section, display an Entity-Relationship Diagram (ERD) or table schema. This immediately proves your relational DB design skills.',
      fb3_title: '3. Live GitHub Activity Widget',
      fb3_desc: 'Embed a widget showing your GitHub commits, top repositories, and languages. It shows transparency and daily coding consistency.',
      fb4_title: '4. Direct Working Contact Form',
      fb4_desc: 'Connect a service like Web3Forms or Formspree so recruiters can send messages straight to your email gerardoburgos1232@gmail.com from the website.',
      fb5_title: '5. Academic Recommendations & Endorsements',
      fb5_desc: 'Request a brief testimonial quote from 1-2 university professors or project leads to display as social proof.',
      fb6_title: '6. Highlight Certifications & Academic Milestones',
      fb6_desc: 'As a final-year student, highlight key coursework, capstone achievements, or certifications (Node.js, SQL, AWS/Docker basics).',
